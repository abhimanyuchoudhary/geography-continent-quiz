...
- **Random** picks Tourist, Globetrotter, or Cartographer once for the whole round and shows that level on the score bar and the results. Difficulty names are plain text.
